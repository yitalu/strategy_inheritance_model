...
tiff(file = "./figures/fertility_vs_wealth_over_time_hazard_9.tiff", width = 2000, height = 1600, res = 300)
ggplot(data=d, aes(x=wealth, y=fertility)) +
  ...
  labs(title="Fertility vs Wealth Over Time (Hazard = 0.9)", x ="Wealth", y = "Fertility") + 
